...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: t.nav.why_us,   path: "/", sectionId: "why" },
    { label: t.nav.services, path: "/", sectionId: "services" },
    { label: t.nav.partners, path: "/", sectionId: "partners" },
    { label: t.nav.market,   path: "/", sectionId: "market" },
  ];
  ...
  const logoSrc = isLight
    ? (settings.logoUrl || "/images/logo.png")
    : (settings.logoWhiteUrl || "/images/logo-white.png");
              ...
              >
                ...
                >
                  ...
                  {pathname === item.path && !item.sectionId && (
                    <motion.div
                      layoutId="activeNav"
                      className={`absolute -bottom-1 left-0 right-0 h-0.5 rounded-full ${isLight ? "bg-[var(--brand-primary)]" : "bg-white"}`}
                    />
                  )}
                </button>
              </motion.div>
