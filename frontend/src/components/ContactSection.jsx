...
export default function ContactSection() {
  ...
  const inputClasses = (field) =>
    `w-full px-5 py-4 bg-gray-50 border-2 rounded-xl focus:outline-none transition-all duration-300 ${
      focusedField === field
        ? "border-[var(--brand-primary)] bg-white shadow-[0_0_0_4px_rgba(var(--brand-primary-rgb),0.08)]"
    ...
    <section id="contact" className="relative py-24 lg:py-32 bg-gradient-to-b from-gray-50 via-white to-gray-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          >
            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-[0_4px_40px_rgba(var(--brand-primary-rgb),0.06)] border border-gray-100 relative overflow-hidden">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-[var(--brand-primary)] to-[#05964a] text-white px-8 py-4 rounded-xl hover:shadow-[0_8px_30px_rgba(var(--brand-primary-rgb),0.25)] transition-all duration-300 flex items-center justify-center gap-3 group text-sm font-semibold tracking-wide disabled:opacity-60"
                  >
                    {isSending
