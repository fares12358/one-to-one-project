...
export default function HeroSection() {
  ...
  const heroImage = t.hero?._images?.[0]?.url;
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center flex-1 flex flex-col justify-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center justify-center gap-2.5 text-xs tracking-[0.2em] uppercase text-[var(--brand-accent)]">
