    ...
    <section id="mission" className="py-24 lg:py-32 bg-linear-to-b from-white via-[#f4faf6] to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={ref} className="text-center max-w-4xl mx-auto">
          ...
          {/* Section heading — preserved from original MissionSection */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            ...
            className="mb-16"
          >
            <h2 className="font-serif text-4xl sm:text-5xl font-normal leading-snug text-[var(--brand-primary)]">
              {m.heading_line1}
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="relative bg-white rounded-3xl p-8 sm:p-12 shadow-[0_4px_40px_rgba(3,115,56,0.08)] border border-[var(--brand-accent)]/20 overflow-hidden text-left">
              {/* Top gradient bar */}
              ...
              <h3 className="text-[var(--brand-primary)] mb-6 font-serif text-3xl sm:text-4xl">
                {m.vision.heading}
              </h3>
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <div className="relative bg-gradient-to-br from-[var(--brand-primary)] to-[#05964a] rounded-3xl p-8 sm:p-12 shadow-[0_8px_40px_rgba(3,115,56,0.25)] overflow-hidden text-left">
              {/* Decorative blurs */}
              ...
              <h3 className="text-white mb-6 font-serif text-3xl sm:text-4xl">
