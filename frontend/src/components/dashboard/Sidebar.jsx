...
import {
  ...
  Compass, AlertTriangle, Star, RefreshCw, Users, Handshake, Building2, TrendingUp, UserSquare2, Mail, PanelBottom,
...
const NAV_CONTENT = [
  ...
  { label: "Philosophy",      href: "/dashboard/philosophy", icon: Compass      },
  { label: "Problem We Solve",href: "/dashboard/problem",    icon: AlertTriangle},
  { label: "Our Services",    href: "/dashboard/services",   icon: Star         },
  { label: "How We Work",     href: "/dashboard/technology", icon: RefreshCw    },
  { label: "Who We Serve",    href: "/dashboard/who-we-serve", icon: Users      },
  { label: "Strategic Partners", href: "/dashboard/partners", icon: Handshake  },
  { label: "Our Clients",     href: "/dashboard/clients",    icon: Building2    },
  { label: "Market Opportunity", href: "/dashboard/market",  icon: TrendingUp   },
  { label: "Our Team",        href: "/dashboard/team",       icon: UserSquare2  },
      ...
      <div className="px-4 py-5 border-b border-white/10 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <div className="relative w-32 h-8">
            <Image src="/images/logo-white.png" alt="One to One" fill className="object-contain object-left" priority />
          </div>
        </Link>
